...
public class ClientThread extends Thread {
	...
	ClientThread(String hostName, String menuSelection, AtomicLong totalTime, boolean printOutput, AtomicLong runningThreads) {
	...
	public void run() {
		...
		try {
			...
			out.println(new String(menuSelection));
